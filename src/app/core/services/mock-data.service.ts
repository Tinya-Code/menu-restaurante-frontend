...
export class MockDataService {
  ...
  private readonly dataImports: Record<string, any> = {
    ...
    'user-5': () => import('../../data/user-5'),
    'user-6': () => import('../../data/user-6'),
    'user-7': () => import('../../data/user-7'),
    'user-8': () => import('../../data/user-8'),
    'user-9': () => import('../../data/user-9'),
    'user-10': () => import('../../data/user-10'),
  };
