...
@Component({
  ...
  template: `
    <app-template-header [restaurantName]="restaurantName()"></app-template-header>
    ...
    <app-layout-scale>
      ...
      <div class="bg-secondary  relative mx-2 ">
        @if (hasAnyCategories() || hasCombos() || hasPromotions()) {
          <div
            class="bg-[url('/assets/template-base-images/contorno-laterales.svg')]  h-full w-auto  mx-2"
          >
