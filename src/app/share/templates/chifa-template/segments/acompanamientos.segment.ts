...
@Component({
  selector: 'app-acompanamientos-segment',
  standalone: true,
    ...
    @if (categories().length > 0) {
      <section class="relative py-12  px-8    ">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-16 items-start">
          ...
          <div
            class="flex justify-center items-center p-8 bg-primary/5 rounded-[40px] border-2 border-dashed border-primary/20 self-stretch"
...
export class AcompanamientosSegmentComponent {
