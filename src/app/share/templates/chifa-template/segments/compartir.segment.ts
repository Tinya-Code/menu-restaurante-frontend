...
@Component({
  selector: 'app-compartir-segment',
  standalone: true,
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-16 items-start">
          ...
          >
              ...
              <ul class=" flex flex-row md:flex-col justify-center items-center gap-4 ">
                <li>
                  <img
                    src="template-chifa-images/images-google/compartir-1.png"
                    alt="Chifa Luck"
               ...
               <li>
                  <img
                    src="template-chifa-images/images-google/compartir-2.png"
                    alt="Chifa Luck"
                    class="w-full md:w-100 h-auto mb-4 "
                  />
                </li>
...
export class CompartirSegmentComponent {
