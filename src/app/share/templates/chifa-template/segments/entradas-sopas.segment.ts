...
@Component({
  selector: 'app-entradas-sopas-segment',
  standalone: true,
          ...
          >
            <div class="flex flex-col w-full items-center text-center ">
              <ul class=" flex flex-row justify-center items-center gap-4 ">
                <li>
              <img
                src="template-chifa-images/images-google/entrada.png"
                alt="Chifa Luck"
              ...
              />
                                ...
                                <li>
              <img
                src="template-chifa-images/images-google/plato-fondo-2.png"
                alt="Chifa Luck"
                class="w-full md:w-100 h-auto  mb-4 "
              />
                </li>
...
export class EntradasSopasSegmentComponent {
