...
@Component({
  selector: 'app-principales-segment',
  standalone: true,
    ...
    @if (categories().length > 0) {
      <section class="relative py-12  px-8    ">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-16 items-start">
          ...
          <div
            class="flex justify-center bg-secondary-muted items-center p-4  rounded-sm border-2 border-dashed border-primary/20 self-stretch"
          ...
          >
            <div class="flex flex-col w-full items-center text-center ">
              <ul class=" flex flex-row md:flex-col justify-center items-center gap-4 ">
                <li>
                  <img
                    src="template-chifa-images/images-google/plato-fondo-1.png"
                    alt="Chifa Luck"
                ...
                <li>
                  <img
                    src="template-chifa-images/images-google/plato-fondo-3.png"
                    alt="Chifa Luck"
                    class="w-full md:w-100 h-auto  mb-4 "
                  />
                </li>
...
export class PrincipalesSegmentComponent {
