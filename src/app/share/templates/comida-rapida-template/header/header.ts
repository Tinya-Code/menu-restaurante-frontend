    ...
    >
      ...
      <div class="max-w-7xl mx-auto flex items-center justify-between relative z-10 skew-y-1">
        <div class="flex items-center gap-5">
          <div
            class="w-16 h-16 bg-secondary rounded-2xl flex items-center justify-center shadow-lg rotate-12"
          >
          ...
          <div>
            ...
            <div
              class="flex items-center gap-2 text-secondary font-black text-xs uppercase italic tracking-widest"
            >
